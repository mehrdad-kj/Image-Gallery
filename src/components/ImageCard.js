...
const ImageCard = ({ image }) => {
  ...
  return (
    <div className="max-w-lg rounded overflow-hidden shadow-2xl bg-[#E9EAEC]">
      <a className='cursor-pointer' href={image.pageURL}><img className="w-full" src={image.webformatURL} alt=""></img></a>
